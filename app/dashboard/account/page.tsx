...
import { User, Mail, Phone, MapPin, Calendar, Shield, Trash2, Save, Camera } from 'lucide-react'
...
export default function AccountPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    bio: "Customer service professional with 5+ years of experience in complaint management and resolution.",
        ...
        <CardContent>
          <Alert className="border-red-200 bg-red-50">
            <AlertDescription className="text-red-800">
              ...
              including complaints, tickets, and personal information. This action cannot be undone.
            </AlertDescription>
          </Alert>
